...
VALUES('bokbok', '이헌복', '1234', 'bokbok@naver.com', '010-1111-2222', '08787', '서울시 관악구 남부순환로 1820 (봉천동, 에그엘로우)', '6층', '0', '2022-12-22 11:44:58', '관리자');
INSERT INTO member(id, name, pass, email, mobile, zipcode, address1, address2, email_get, reg_date, nickname)
VALUES('midas', '원 진', '1234', 'midas@naver.com', '010-2222-3333', '08802', '서울시 관악구 남부순환로 1820 (봉천동, 에그엘로우)', '14층', '1', '2022-12-23 11:44:58', '미다스');
