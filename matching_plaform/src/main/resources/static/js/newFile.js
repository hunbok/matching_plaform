$(function() {
	$(".btnReply").click(function() {
		...
		$.ajax({
			url: "/empathy.ajax",
			type: "POST",
			data: { empathy: com, replyNo: $("#replyNo").val() },
			dataType: "json",
			success: function(data) {
				var msg = com == 'replyLike' ? "좋아요가 " : "싫어요가 ";
				alert(msg + " 반영 되었습니다.");
				$("#replyLike > .empathy").text(" (" + data.replyLike + ")");
				$("#replyDisLike > .empathy").text(" (" + data.replyDisLike + ")");
			},
